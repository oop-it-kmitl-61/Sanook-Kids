 ...
 * @author Husna
 */
public class Ch5ChooseLevel extends javax.swing.JFrame {

    /**
     * Creates new form Ch5ChooseLevel
     */
    public static final String TITLE = "สนุก Kids";
    public static final int WIDTH = 800;
    public static final int HEIGHT = 480;
    
    public Ch5ChooseLevel() {
        initComponents();
        setTitle(TITLE);
    ...
    private void initComponents() {
        ...
        bnEasy.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/choose/level/2-easy.png"))); // NOI18N
        ...
        bnMedium.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/choose/level/2-medium.png"))); // NOI18N
        ...
        bnHard.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/choose/level/2-hard.png"))); // NOI18N
    ...
    private void bnMediumActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnMediumActionPerformed
        Ch5CompareMedium m = new Ch5CompareMedium();
        m.setVisible(true);
        close();
    ...
    private void bnHardActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnHardActionPerformed
        Ch5CompareHard h = new Ch5CompareHard();
        h.setVisible(true);
        close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ch5ChooseLevel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ch5ChooseLevel().setVisible(true);
            }
        });
    }
