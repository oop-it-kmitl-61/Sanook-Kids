...
public class QuestionMedium {
    ...
    public QuestionMedium(ImageIcon imageQuestion, ImageIcon answer1, ImageIcon answer2, ImageIcon answer3, ImageIcon answer, String ans) {
    ...
    public void setAnswer(ImageIcon answer) {
        this.answer = answer;
    }
