 ...
 * @author Husna
 */
public class Ch4ChooseLevel extends javax.swing.JFrame {

    /**
     * Creates new form Ch4ChooseLevel
     */
     public static final String TITLE = "สนุก Kids";
	public static final int WIDTH = 800;
	public static final int HEIGHT = 480;
        
    public Ch4ChooseLevel() {
        initComponents();
        setTitle(TITLE);
    ...
    private void initComponents() {
        ...
        bnHard.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/choose/level/1-hard.png"))); // NOI18N
        ...
        bnMedium.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/choose/level/1-medium.png"))); // NOI18N
        ...
        jLabel2.setBounds(50, -10, 300, 450);
        ...
        bnEasy.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/choose/level/1-easy.png"))); // NOI18N
    ...
    private void bnMediumActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnMediumActionPerformed
        Ch4SubMedium m = new Ch4SubMedium();
        m.setVisible(true);
        close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ch4ChooseLevel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ch4ChooseLevel().setVisible(true);
            }
        });
    }
